...
async function getCityData(slug: string) {
  ...
  if (error || !data) return { submissions: [], p25: 0, p75: 0, p90: 0, city, count: 0 }
...
export default async function CityPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { submissions, p25, p75, p90, city, count } = await getCityData(slug)
        ...
        <div className="mx-auto max-w-7xl">
          ...
          {submissions.length > 0 ? (
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-2xl p-16 text-center shadow-sm">
              <p className="text-[#9CA3AF] text-base mb-4">No submissions yet for {city}.</p>
              <Link
                href="/submit"
