...
export default function StateClient({ submissions, state }: Props) {
        ...
        <div className="mt-10">
          ...
          {hasSalaryData ? (
            ...
            <p className="mt-4 text-sm text-[#94A3B8]">
              Not enough data yet for {selectedProfession === 'All Professions' ? state : `${selectedProfession} in ${state}`}.
            </p>
          )}
        </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-[#E1E8EF] pt-10 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[#64748B]">
              ...
              by state, city, facility, role, and experience level with confidence.
            </p>
          </div>
